...
const CreateProduct: React.FC = () => {
        ...
        return (
          <div className="space-y-8 animate-fadeIn">
            ...
            {previewUrls.length > 0 && (
              <div className="space-y-4">
                <h4 className="text-sm font-bold text-gray-900 uppercase tracking-wider">New Images</h4>
        ...
        return (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="mt-8 p-6 bg-brand-primary/5 rounded-3xl border border-brand-primary/10 flex items-start gap-4">
                ...
                <p className="text-sm text-brand-primary/80 leading-relaxed">Please review all information before submitting. New images will be added to the product gallery.</p>
            </div>
          </div>
        );
      default:
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <button onClick={() => navigate('/products')} className="flex items-center text-gray-500 mb-6 hover:text-brand-primary transition-colors group">
        <MdArrowBack className="mr-2 group-hover:-translate-x-1 transition-transform" /> Back to Products
      </button>
        ...
        <div className="p-5">
          <form className="space-y-8">
            ...
            <div className="pt-6 border-t border-gray-100 flex items-center justify-between gap-4">
              <button type="button" onClick={currentStep === 1 ? () => navigate('/products') : goToPrevStep} className="btn-secondary px-8">{currentStep === 1 ? 'Cancel' : 'Previous'}</button>
              {activeTab === 'summary' ? (
                <button type="button" onClick={handleSubmit} className="btn-primary px-12" disabled={createProduct.isPending}>{createProduct.isPending ? 'Processing...' : 'Create Product'}</button>
              ) : (
