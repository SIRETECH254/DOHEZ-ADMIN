...
const CreateVendorCategory: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <button onClick={() => navigate('/vendor-categories')} className="flex items-center text-gray-500 mb-6 hover:text-brand-primary transition-colors">
        <MdArrowBack className="mr-2" /> Back to Categories
      </button>
