...
import type { IVendorCategory, IUser, IService, ILocationResult } from '../../../types/api.types';
...
const CreateVendor: React.FC = () => {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    // Safety guard: Only allow submission from the summary tab
          ...
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="mt-8 p-6 bg-brand-primary/5 rounded-3xl border border-brand-primary/10 flex items-start gap-4">
              ...
              <p className="text-sm text-brand-primary/80 leading-relaxed">
                Review complete. Please ensure all information above is accurate. By clicking "Complete Registration", you confirm that you have verified all provided details.
              </p>
            </div>
          </div>
        );
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Register New Vendor</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="pt-6 border-t border-gray-100 flex items-center justify-between gap-4">
              ...
              {activeTab === 'summary' ? (
                ...
                >
                  {registerVendor.isPending ? 'Processing...' : 'Complete Registration'}
                </button>
              ) : (
                <button
                  key="continue-btn"
